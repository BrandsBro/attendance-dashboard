            ...
            <div className="card">
              {status === 'loading' ? (
                <div style={{ textAlign: 'center', padding: '60px 20px' }}>
                  ...
                  <div style={{ fontSize: 16, fontWeight: 600, color: 'var(--text)' }}>Loading attendance data...</div>
                  <div style={{ fontSize: 13, color: 'var(--text-muted)', marginTop: 6 }}>Fetching from Google Sheets</div>
                </div>
              ) : (
